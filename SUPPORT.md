...
- Check the [`README`](https://github.com/igorskyflyer/npm-rawelement/blob/main/README.md) for documentation and setup guidance.
- Search [`issues`](https://github.com/igorskyflyer/npm-rawelement/issues) to see if your question has already been answered.
...
- opening a [`new issue`](https://github.com/igorskyflyer/npm-rawelement/issues) using the appropriate issue template and with the label of `feature`,
...
- See [`CONTRIBUTING.md`](https://github.com/igorskyflyer/npm-rawelement/blob/main/CONTRIBUTING.md) for guidelines.
